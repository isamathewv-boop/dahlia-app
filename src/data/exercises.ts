...
export const EXERCISES: Exercise[] = [
  ...
  { name: 'Pike push-up', focus: 'upper', requires: 'bodyweight' },
  { name: 'Diamond push-up', focus: 'upper', requires: 'bodyweight' },
  { name: 'Chair dip', focus: 'upper', requires: 'bodyweight' },
  { name: 'Prone Y-raise', focus: 'upper', requires: 'bodyweight' },
  ...
  { name: 'Squat thrust', focus: 'full-body', requires: 'bodyweight' },
  { name: 'Crab walk', focus: 'full-body', requires: 'bodyweight' },
  { name: 'Get-up from the floor', focus: 'full-body', requires: 'bodyweight' },
